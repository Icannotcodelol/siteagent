    ...
    <footer className="border-t border-gray-200 bg-gradient-to-br from-white to-gray-50 py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          {[
            { title: "Prodotto", links: [{ label: "Caratteristiche", href: "#features" }, { label: "Prezzi", href: "#pricing" }, { label: "Contatore Token AI", href: "/tools/token-counter" }, { label: "Documentazione", href: "/docs" }, { label: "Changelog", href: "/changelog" }] },
