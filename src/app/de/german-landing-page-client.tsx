      ...
      <div className="container relative mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
            ...
            <Link
              href="#live-demo"
              className="border-2 border-white bg-white/20 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/30 transition-all duration-300 flex items-center gap-3"
            >
