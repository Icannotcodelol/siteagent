...
function MouseFollower() {
  ...
  useEffect(() => {
    const updatePosition = (e: MouseEvent) => {
      ...
      // Show the cursor after initial movement
      setIsHidden(false);
    };
...
function HeroSection() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Move orbs in opposite directions for parallax effect
      ...
      // Subtle tilt effect on the preview
  ...
  const features = [
    {
      ...
      description:
        "Create intelligent conversational agents that understand context and provide helpful responses to your users.",
    },
    {
      icon: Webhook,
      title: "External API Actions",
      description:
        "Connect your chatbot to third-party services like Calendly, HubSpot, Jira, and Shopify to perform real actions.",
    },
    {
      icon: FileText,
      title: "Document Knowledge Base",
      description:
        "Upload documents and let your chatbot answer questions based on their content using advanced RAG technology.",
    },
    {
      icon: Globe,
      title: "Website Embedding",
      description:
        "Easily embed your chatbots into any website with a simple code snippet that works across all platforms.",
    },
    {
      icon: Database,
      title: "Powerful Analytics",
      description:
        "Track conversations, user satisfaction, and chatbot performance with comprehensive analytics.",
    },
    {
      icon: Lock,
      title: "Enterprise Security",
      description:
        "Keep your data secure with end-to-end encryption, role-based access control, and compliance features.",
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        "Set up your chatbot in minutes with our intuitive dashboard. Define its purpose and personality.",
    ...
    },
    {
      ...
      description:
        "Upload documents or connect to your existing knowledge base to give your chatbot the information it needs.",
      features: ["Document upload (PDF, DOCX, etc.)", "Website scraping", "Database connections"],
    },
    {
      number: "03",
  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Document upload (up to 50 pages)",
        "Basic analytics",
        "Email support",
      ],
      cta: "Get Started",
    ...
    },
    {
      ...
      features: [
        ...
        "Document upload (up to 500 pages)",
        "Advanced analytics",
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote:
        "SiteAgent has transformed our customer support. Our chatbot handles 70% of inquiries automatically, saving us countless hours.",
    ...
    {
      quote:
        "The ability to connect our chatbot to our CRM and scheduling tools has been a game-changer. It's like having an extra team member.",
      author: "Michael Chen",
    ...
    {
      quote:
        "We uploaded our product documentation and within minutes had a chatbot that could answer technical questions accurately. Impressive!",
            ...
            >
              <div className="mb-4 flex">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="h-5 w-5 fill-current text-yellow-500 transition-all duration-300 group-hover:scale-110 group-hover:text-yellow-400"
                  />
                ))}
              </div>
  ...
  const faqs = [
    {
      ...
      answer:
        "No, SiteAgent is designed to be user-friendly for non-technical users. Our intuitive interface allows you to create and deploy chatbots without any coding knowledge. For more advanced customizations, some technical background may be helpful but is not required.",
    },
    {
      question: "How does the document knowledge base work?",
      answer:
        "SiteAgent uses Retrieval Augmented Generation (RAG) technology. You upload documents (PDFs, DOCXs, etc.) to our platform, and we process them to create embeddings. When a user asks a question, our system retrieves the most relevant information from your documents and uses it to generate accurate answers.",
    },
    {
      question: "Can I connect my chatbot to my existing tools?",
      answer:
        "Yes! SiteAgent supports integrations with many popular third-party services through our Actions feature. You can connect to tools like Calendly, HubSpot, Jira, Shopify, and more. This allows your chatbot to perform tasks like scheduling appointments, updating CRM data, or creating tickets.",
    },
    {
      question: "How do I embed the chatbot on my website?",
      answer:
        "Once you've created your chatbot, you'll receive a simple JavaScript snippet to add to your website. Just paste this code into your site's HTML, and the chatbot will appear. You can customize the appearance and position of the chatbot widget to match your website's design.",
    },
    {
      question: "Is there a limit to how many messages my chatbot can handle?",
      answer:
        "Each pricing plan comes with a specific monthly message limit. The Starter plan includes 5,000 messages per month, the Professional plan includes 25,000 messages, and the Enterprise plan offers unlimited messages. If you exceed your limit, additional messages are billed at a per-message rate.",
    },
    {
      question: "How secure is my data with SiteAgent?",
      answer:
        "We take security seriously. All data is encrypted both in transit and at rest. We use industry-standard security practices and regularly undergo security audits. For Enterprise customers, we offer additional security features like SSO, role-based access control, and custom data retention policies.",
    },
  ];
